...
def get_dataset(path="dataset/cullpdb+profile_6133.npy"):
    ...
    ret[:, :, 0:amino_acid_residues] = ds[:, :, 35:56] #primary profile copy from 0 to 20 index of ds
    ret[:, :, amino_acid_residues:] = ds[:, :, amino_acid_residues + 1:amino_acid_residues+ 1 + num_classes]  #secondary label copy form ds 22 to 28
    return ret
